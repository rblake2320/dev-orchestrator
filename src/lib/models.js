...
export const MODEL_OPTIONS = [
  ...
  { id: 'gemini-flash',      label: 'Gemini 2.0 Flash',     provider: 'gemini',      model: 'gemini-2.0-flash-001',        tier: 'frontier', badge: '✦',  color: '#4285f4' },
  { id: 'gemini-pro',        label: 'Gemini 1.5 Pro',       provider: 'gemini',      model: 'gemini-1.5-pro-001',          tier: 'frontier', badge: '✦',  color: '#34a853' },
